...
const districts = {
  ...
  Alberta: ['Calgary', 'Edmonton', 'Red Deer', 'Fort McMurray'],
  'New South Wales': ['Sydney', 'Newcastle', 'Wollongong', 'Coffs Harbour'],
  Queensland: ['Brisbane', 'Cairns', 'Townsville', 'Gold Coast'],
...
export { countries, states, districts };
